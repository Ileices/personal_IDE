...
3. **Open Copilot Studio** — Click the ✨ Sparkles icon in the left Activity Bar to open the self-improvement agent chat.
4. **Start building** — Type a request in Copilot Studio. The agent will read your codebase, propose changes, and apply them.
...
- **BUILD AND RUN** button = smart-start your project (auto-detects npm, cargo, go, python)`,
    links: [
      ...
      { label: 'Copilot Studio', sectionId: 'studio' },
      { label: 'Agent Mode', sectionId: 'agent' },
    ],
    tips: [
      'Use free providers (Groq, Cerebras, Gemini Flash) for most tasks to avoid costs.',
      'Enable Auto-backup in Copilot Studio before asking the agent to edit files.',
...
Copilot Studio is the centerpiece of Personal IDE. It is a full conversational agent that has access to your codebase, terminal, and the web. Use it to build features, fix bugs, and improve the IDE itself.
...
- **Agent stalls on new projects** — Check if the project template was applied. Use Copilot Studio to diagnose.
