...
const DEFAULT_TASKS: TaskModelAssignment[] = [
  {
    ...
    assignedModels: ['openai/gpt-4.1-mini', 'openai/gpt-4.1-nano', 'openai/gpt-4o-mini', 'groq/llama-3.3-70b-versatile'],
    cooldownMs: 5000,
    enabled: true,
  ...
  },
  {
    ...
    assignedModels: ['openai/gpt-4o-mini', 'openai/gpt-4.1-mini', 'openai/gpt-4.1-nano', 'groq/llama-3.3-70b-versatile'],
    cooldownMs: 5000,
    enabled: true,
  ...
  },
  {
    ...
    assignedModels: ['openai/gpt-4.1', 'openai/gpt-4.1-mini', 'openai/gpt-4o', 'cerebras/llama-4-scout-17b-16e-instruct'],
    cooldownMs: 10000,
    enabled: false,
  ...
  },
  {
    ...
    assignedModels: ['openai/gpt-4.1-nano', 'openai/gpt-4.1-mini', 'openai/gpt-4o-mini', 'groq/llama-3.3-70b-versatile'],
    cooldownMs: 3000,
    enabled: true,
