...
export async function tierRoutes(app: FastifyInstance) {
  ...
  app.post('/detect', async (req: FastifyRequest) => {
  ...
  app.get('/:projectId', async (req: FastifyRequest, reply: FastifyReply) => {
  ...
  app.post('/decide-language', async (req: FastifyRequest) => {
