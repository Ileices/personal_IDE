...
export async function knowledgeRoutes(app: FastifyInstance) {
  ...
  app.post('/scan', safeRoute(async (req: FastifyRequest) => {
  ...
  app.get('/symbols/:projectId/:filePath', safeRoute(async (req: FastifyRequest) => {
  ...
  app.get('/symbols/:projectId', safeRoute(async (req: FastifyRequest) => {
  ...
  app.get('/relationships/:symbolId', safeRoute(async (req: FastifyRequest) => {
  ...
  app.get('/conflicts/:projectId', safeRoute(async (req: FastifyRequest) => {
    const { projectId } = req.params as { projectId: string };
  ...
  app.get('/stats/:projectId', safeRoute(async (req: FastifyRequest) => {
    const { projectId } = req.params as { projectId: string };
